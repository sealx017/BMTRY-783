...
pca <- data.frame(sample.id = row.names(Geno1), EV1 = pca$eigenvect[, 1], EV2 = pca$eigenvect[, 2], EV3 = pca$eigenvect[, 3], EV3 = pca$eigenvect[, 4], stringsAsFactors = FALSE)
# Plot the PCA
...
pca_1 <- read.csv("/Users/sealso/Research/Teaching/Data/RiceDiversity.44K.germplasm.csv", 
...
rice.pheno <- read.table("/Users/sealso/Research/Teaching/Data/RiceDiversity_44K_Phenotypes_34traits_PLINK.txt", 
